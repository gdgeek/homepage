...
const messages = {
  en: {
    ...
    hero: {
      title:
        "3D + UGC <br><span class='text-gradient'>Create Your World</span>",
      subtitle:
        "Empowering Education with AR + AI. <br>Based in Macau, Serving the World. <br>Seamless multi-device interaction and large-screen casting.",
    ...
    about: {
      ...
      subtitle:
        "The ultimate tool for teachers and students to create immersive AR content without coding.",
      card1: {
        title: "Upload Models",
    ...
    footer: {
      ...
      copyright:
        "&copy; 2025 3dugc.com. Macau Headquarters. Xia Ding Technology. All rights reserved.",
    },
  },
  "zh-CN": {
    nav: {
    ...
    hero: {
      ...
      subtitle:
        "用 AR + AI 赋能教育。<br>立足澳门，服务全球。<br>无缝的多设备互动与大屏幕投屏，专为课堂打造。",
      explore: "支持设备",
      learn: "了解更多",
    },
    about: {
    ...
    footer: {
      ...
      subscribe: { btn: "订阅" },
      copyright: "&copy; 2025 3dugc.com. 澳门总部. 夏鼎科技. 版权所有.",
    },
  },
  "zh-TW": {
    nav: {
    ...
    login: {
      ...
      success: "✅ 登錄成功！",
      failed: "登錄失敗，請重試",
      defaultError: "登錄失敗，請稍後重试",
    },
    errors: {
      "no user": "用戶不存在",
      "wrong password": "密碼錯誤",
      "wrong username": "用戶名錯誤",
      "user not found": "用戶不存在",
      "invalid credentials": "用戶名或密碼錯誤",
      "account disabled": "賬號已被禁用",
      "account locked": "賬號已被鎖定",
      "too many attempts": "登錄嘗試次數過多",
      "network error": "網絡錯誤",
      "server error": "服務器錯誤",
    },
    hero: {
      ...
      subtitle:
        "用 AR + AI 賦能教育。<br>立足澳門，服務全球。<br>無縫的多設備互動與大屏幕投屏，專為課堂打造。",
      explore: "支持設備",
      learn: "了解更多",
    },
    about: {
    ...
    footer: {
      ...
      subscribe: { btn: "訂閱" },
      copyright: "&copy; 2025 3dugc.com. 澳門總部. 夏鼎科技. 版權所有.",
    },
  },
  ja: {
    nav: {
    ...
    login: {
      ...
      defaultError: "ログインに失敗しました。後でもう一度お試しください",
    },
    errors: {
      "no user": "ユーザーが存在しません",
      "wrong password": "パスワードが間違っています",
      "wrong username": "ユーザー名が間違っています",
      "user not found": "ユーザーが見つかりません",
      "invalid credentials": "ユーザー名またはパスワードが無効です",
      "account disabled": "アカウントが無効化されています",
      "account locked": "アカウントがロックされています",
      "too many attempts": "ログイン試行回数が多すぎます",
    ...
    hero: {
      ...
      subtitle:
        "AR + AIで教育を支援。<br>マカオを拠点に、世界へ。<br>教室のためのシームレスなマルチデバイスインタラクションと大画面キャスト。",
      explore: "対応デバイス",
      learn: "詳細を見る",
    },
    about: {
      title: "ノーコード作成",
      subtitle:
        "教師と生徒がコードを書かずに没入型AR教材を作成できる究極のツール。",
      card1: {
        title: "モデルのアップロード",
    ...
    footer: {
      ...
      subscribe: { btn: "購読する" },
      copyright:
        "&copy; 2025 3dugc.com. マカオ本部. Xia Ding Technology. All rights reserved.",
    },
  },
  th: {
    nav: {
    ...
    login: {
      ...
      defaultError: "เข้าสู่ระบบไม่สำเร็จ กรุณาลองอีกครั้งในภายหลัง",
    },
    errors: {
      "no user": "ไม่พบผู้ใช้",
      "wrong password": "รหัสผ่านผิด",
      "wrong username": "ชื่อผู้ใช้ผิด",
      "user not found": "ไม่พบผู้ใช้",
      "invalid credentials": "ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง",
      "account disabled": "บัญชีถูกปิดใช้งาน",
      "account locked": "บัญชีถูกล็อค",
      "too many attempts": "พยายามเข้าสู่ระบบมากเกินไป",
    ...
    hero: {
      ...
      subtitle:
        "เสริมพลังการศึกษาด้วย AR + AI <br>ฐานปฏิบัติการในมาเก๊า ให้บริการทั่วโลก <br>การโต้ตอบหลายอุปกรณ์ที่ราบรื่นและการแคสต์หน้าจอขนาดใหญ่",
    ...
    about: {
      ...
      subtitle:
        "เครื่องมือที่ดีที่สุดสำหรับครูและนักเรียนในการสร้างเนื้อหา AR ที่สมจริงโดยไม่ต้องเขียนโค้ด",
      card1: {
        title: "อัปโหลดโมเดล",
    ...
    footer: {
      ...
      copyright:
        "&copy; 2025 3dugc.com. สำนักงานใหญ่มาเก๊า. Xia Ding Technology. สงวนลิขสิทธิ์",
    },
  },
};
